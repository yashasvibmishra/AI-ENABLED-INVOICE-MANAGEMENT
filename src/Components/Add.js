...
import {
  Button, TextField, Dialog, DialogActions, Box,
  DialogContent, DialogTitle, Grid, makeStyles
...
export default function Add(props) {
  ...
  const handleSubmit = (e) => {
    setOpen(false);
    e.preventDefault()
    // use axios to make a post request to the server with the data we want to add to the database
    axios.post("http://localhost:8081/backend_hrc_final/Add",
      {},
            ...
            <Grid container spacing={4}>
              <Grid item xs={3}>
                <TextField style={tfStyles} name="business_code" onChange={handleChange}
                  value={business_code} label="Business Code" variant="filled" />
              </Grid>
              <Grid item xs={3}>
