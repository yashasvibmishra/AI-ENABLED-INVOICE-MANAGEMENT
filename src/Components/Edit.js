...
export default function Edit(props) {
  ...
  const handleClickOpen = () => {
    setOpen(true);
    console.log({
      invoice_currency: props.edit.invoice_currency,
      cust_payment_terms: props.edit.cust_payment_terms,
    });
  };
  ...
  const handleReset = (e) => {
    ...
    e.preventDefault();
    axios.post(
      "http://localhost:8081/backend_hrc_final/Edit",
      {},
      {
        params: {
            ...
            <Grid container spacing={3}>
              <Grid item xs={6}>
                <TextField
                  ...
                  value={props.edit.invoice_currency}
              ...
              <Grid item xs={6}>
                <Box noValidate autoComplete="off">
                  <TextField
                    ...
                    onChange={props.handleChange}
                    value={props.edit.cust_payment_terms}
